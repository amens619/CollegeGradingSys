...
namespace CollegeGradingSys.ViewModels.StAcademic
{
    public class StAcademicDataVM
    {
        ...
        public virtual Models.AcademicYear AcademicYear { get; set; }
        public virtual Models.Batch Batch { get; set; }

        public virtual Models.StPersonalData StPersonalData { get; set; }
        public virtual ICollection<Models.CourseGrade> CourseGrades { get; set; }
